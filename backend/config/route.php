...
Route::post('/api/v1/user/auth/login', [UserAuthController::class, 'login']);
Route::post('/api/v1/admin/auth/login', [AdminAuthController::class, 'login']);
...
Route::get('/api/v1/admin/question-category/list', [QuestionController::class, 'categories']);
Route::get('/api/v1/admin/question-type/list', [QuestionController::class, 'types']);
Route::get('/api/v1/admin/question-source/list', [QuestionController::class, 'sources']);
Route::get('/api/v1/admin/question-tag/list', [QuestionController::class, 'tags']);
...
Route::get('/api/v1/admin/log/search/list', [AdminSearchLogController::class, 'index']);
Route::get('/api/v1/admin/doc/article/list', [DocManageController::class, 'index']);
...
Route::get('/api/v1/admin/collect/task/list', [CollectManageController::class, 'index']);
...
Route::get('/open/v1/quota/detail', [OpenSearchController::class, 'quota']);

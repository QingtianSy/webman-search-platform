...
return [
    ...
    ['DELETE', '/api/v1/user/api-key/delete', [ApiKeyController::class, 'delete']],
    ...
    ['GET', '/api/v1/admin/question-category/list', [QuestionController::class, 'categories']],
    ['GET', '/api/v1/admin/question-type/list', [QuestionController::class, 'types']],
    ['GET', '/api/v1/admin/question-source/list', [QuestionController::class, 'sources']],
    ['GET', '/api/v1/admin/question-tag/list', [QuestionController::class, 'tags']],
    ...
    ['DELETE', '/api/v1/admin/announcement/delete', [AnnouncementController::class, 'delete']],
    ['GET', '/api/v1/admin/log/search/list', [AdminSearchLogController::class, 'index']],
    ['GET', '/api/v1/admin/doc/article/list', [DocManageController::class, 'index']],
    ...
    ['DELETE', '/api/v1/admin/doc/article/delete', [DocManageController::class, 'delete']],
    ['GET', '/api/v1/admin/collect/task/list', [CollectManageController::class, 'index']],
    ['GET', '/api/v1/admin/collect/task/detail', [CollectManageController::class, 'detail']],
    ['POST', '/api/v1/admin/collect/task/stop', [CollectManageController::class, 'stop']],
    ['POST', '/api/v1/admin/collect/task/retry', [CollectManageController::class, 'retry']],
    ...
    ['GET', '/open/v1/quota/detail', [OpenSearchController::class, 'quota']],
